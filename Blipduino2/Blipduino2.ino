...
Color pink = blip_color("#F08");
Color teal = blip_color("#0F8");
...
void Ocean() {
  const Color darkblue = blip_color("#006");
  const Color darkteal = blip_color("#063");
  const Color skyblue = blip_color("#8CF");
